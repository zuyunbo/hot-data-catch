...
class SpiderV6(object):
    ...
    def start_spider(self):
        ...
        trs_list = html.xpath('//*[@class="hotNews-list2"]/li')
        result = []
        for _, tr in enumerate(trs_list):
            tr_title = tr.xpath(".//a/text()")[0].strip()
            tr_url = tr.xpath(".//a/@href")[0].strip()
    ...
    def start(self):
        print('执行网易爬虫')
        baseurl = 'https://js.news.163.com/suzhou/'
        select_bre = SpiderV6(baseurl=baseurl)
